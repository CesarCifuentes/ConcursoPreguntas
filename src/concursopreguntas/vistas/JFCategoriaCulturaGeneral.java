 ...
 * @author Baloo
 */
public class JFCategoriaCulturaGeneral extends javax.swing.JFrame {

    /**
     * Creates new form JFCategoriaCulturaGeneral
     */
    public JFCategoriaCulturaGeneral() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFCategoriaCulturaGeneral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFCategoriaCulturaGeneral().setVisible(true);
            }
        });
    }
