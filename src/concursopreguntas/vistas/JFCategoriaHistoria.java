 ...
 * @author Baloo
 */
public class JFCategoriaHistoria extends javax.swing.JFrame {

    /**
     * Creates new form JFCategoriaHistoria
     */
    public JFCategoriaHistoria() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFCategoriaHistoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFCategoriaHistoria().setVisible(true);
            }
        });
    }
